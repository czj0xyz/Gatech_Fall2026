...
for bound in bounds:
    bound_name, bound_function = bound
    print(bound_function, CountMisses(bound_function, n,p, num_samples))
print("n=1000,p=0.1","δ=0.1",)   
n=1000
p=0.1
num_samples=10**6
for bound in bounds:
    bound_name, bound_function = bound
    print(bound_function, CountMisses(bound_function, n,p, num_samples, 0.1))
print("n=1000,p=0.1","δ=0.02",)
n=1000
p=0.1
num_samples=10**6
for bound in bounds:
    bound_name, bound_function = bound
    print(bound_function, CountMisses(bound_function, n,p, num_samples, 0.02))
